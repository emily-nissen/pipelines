...
When they use the NuGEN Ovation technology, the genomics core is not able to convert the BCL to FastQ files, and we will have to do it. They usually add in the additional 6 bases of random UMI for duplicate marking feature to determine PCR duplicates. 
